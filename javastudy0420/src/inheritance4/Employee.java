...
public class Employee {
	...
	//empNo를 일련번호로 만들기 위한 static 변수 - 공유(1개만 만들어진다.)
	...
	//접근자 메소드
		//프로퍼티를 private으로 만들어서 인스턴스가 프로퍼티에 접근할 수가 없어서
		//getter와 setter를 이용해서 접근
	...
	//확인하는 것은 자원의 낭비이기 때문에 한꺼번에 확인하기 위한 메소드
	//나중에는 toString()으로 생성
	
	public String resultStr() {
		String result = "사원번호: " + empNo
						+ "이름: " + empName
						+ "부서: " + empPart;
		return result;
	}
